...
They are also smaller than cuckoo filters. They are used in production systems such as [databend](https://github.com/datafuselabs/Databend), [ntop](https://github.com/ntop/nDPI), [InfiniFlow](https://github.com/infiniflow/infinity), and [Pebble](https://github.com/cockroachdb/pebble).
